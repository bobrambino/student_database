...
CREATE TABLE `student` (
  ...
  CONSTRAINT `class_id` FOREIGN KEY (`class_id`) REFERENCES `classroom` (`class_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `subject` (
  ...
  KEY `teacher_id_idx` (`teacher_id`),
  CONSTRAINT `student_id` FOREIGN KEY (`teacher_id`) REFERENCES `student` (`student_id`),
...
-- Dump completed on 2024-01-03 20:09:52
